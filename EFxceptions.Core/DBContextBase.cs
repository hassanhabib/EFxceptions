...
{
    public abstract class DbContextBase<TDbException, TCode> : DbContext
        where TDbException : DbException
    {
        private IEFxceptionService eFxceptionService;
        private IDbErrorBroker<TDbException, TCode> errorBroker;
        ...
        protected abstract IDbErrorBroker<TDbException, TCode> CreateErrorBroker();
        protected abstract IEFxceptionService CreateEFxceptionService(
            IDbErrorBroker<TDbException, TCode> errorBroker);
